...
@pytest.mark.parametrize(("world_x", "world_y", "map_x", "map_y"), [(-300245, -76290.4, 542.348288, -1280.3136), (-362088, -152570, 444.7104, -1359.47264)])
...
def test_map_grid_and_limits():
    service = MapService()
    assert service.map_to_grid(542.348288, -1280.3136) == "H11"
